...
<body class="page-class_rule" banner="6">
	...
	<div class="rule">
		<div class="container">
			<p class="location"><a href="/">首页</a><em>></em><a href="/class.html">棋牌学堂</a><em>></em>棋牌规则</p>
			<div class="box-rule c">
				<#if (list?? && 0 < list?size)>
					<#list list as l>
						<div class="game">
							<img width="102" height="102" src="${l.gamePicture}" />
							<em>${l.gameTitle}</em>
							<p><#if (62 < l.gameRule?length)>${l.gameRule[0..62]}<#else>${l.gameRule}</#if></p>
